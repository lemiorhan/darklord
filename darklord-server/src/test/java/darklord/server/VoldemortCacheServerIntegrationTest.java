...
public class VoldemortCacheServerIntegrationTest {
    ...
    public void doBefore() throws Exception {
        ...
        serverProps = PropertiesUtils.loadFromClasspathResource(this.getClass(), serverPropertiesPath + File.separator + "server.properties");
    ...
    public void doAfter() throws IOException {
        ...
        FileUtils.deleteDirectory(new File(serverProps.getProperty("bdb.data.directory"))); // do the cleanup
    }
